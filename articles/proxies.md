...
#> [1] TRUE
proxy_log(proxy)
#> GET http://127.0.0.1:33925/get  (credentials: no)
```
...
proxy_log(proxy)
#> GET http://127.0.0.1:33925/get  (credentials: no)
#> GET http://127.0.0.1:33925/uuid  (credentials: no)
#> GET http://127.0.0.1:33925/ip  (credentials: no)
```
...
#> [1] 200
proxy_log(guarded)
#> GET http://127.0.0.1:33925/headers  (credentials: yes)
```
...
#> Error in `zu_perform()`:
#> ! GET http://127.0.0.1:33925/get failed: HTTP 407 Proxy Authentication Required
