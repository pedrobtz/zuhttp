...
req
#> <zu_request>
#> GET http://127.0.0.1:39297/get?api_key=<redacted>&page=2
...
#> > GET http://127.0.0.1:39297/gzip
#> * 0ms     +0     request.start     http://127.0.0.1:39297/gzip
...
#> < HTTP 200
#> <   Date: Sat, 26 Sep 2026 06:45:02 GMT
...
#> 1      request.start     0   0 http://127.0.0.1:39297/redirect/1
...
#> 8  redirect.followed     8   1        http://127.0.0.1:39297/get
...
#> 1    GET        http://127.0.0.1:39297/get    200  1
#> 2   POST       http://127.0.0.1:39297/post    200 44
#> 3    GET http://127.0.0.1:39297/status/404    404 44
```
